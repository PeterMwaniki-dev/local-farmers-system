...
const Register = () => {
  ...
  return (
    <div className={`min-h-screen flex ${darkMode ? 'bg-gray-900' : 'bg-white'}`}>
      ...
      <div className={`w-full lg:w-3/5 flex items-center justify-center p-8 ${darkMode ? 'bg-gray-900' : 'bg-white'} overflow-y-auto`}>
        <div className="w-full max-w-lg py-8">
          ...
          <div className="text-center mb-6">
            <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>Create your account to get started</p>
          </div>
          ...
          <div className="mt-5 text-center">
            <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
              ...
              <Link to="/login" className={`font-semibold hover:underline ${darkMode ? 'text-green-400 hover:text-green-300' : 'text-green-600 hover:text-green-700'}`}>
                Sign in
              </Link>
            </p>
          </div>
