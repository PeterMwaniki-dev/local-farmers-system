...
const Landing = () => {
  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'bg-gray-900' : 'bg-gradient-to-b from-green-50 to-white'}`}>
      {/* Navigation */}
      <nav className={`${darkMode ? 'bg-gray-800 shadow-lg' : 'bg-white shadow-md'} sticky top-0 z-50`}>
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <Link to="/" className="flex items-center gap-2">
              ...
              />
              <span className={`text-2xl font-bold ${darkMode ? 'text-green-400' : 'text-green-600'}`}>Sonnet Shamba</span>
            </Link>

            {/* Navigation Links */}
            <div className="hidden md:flex items-center gap-6">
              <a href="#features" className={`hover:text-green-600 transition ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>Features</a>
              <a href="#how-it-works" className={`hover:text-green-600 transition ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>How It Works</a>
              <a href="#about" className={`hover:text-green-600 transition ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>About</a>
              ...
              {isAuthenticated ? (
                ...
                <div className="flex gap-3">
                  <Link
                    to="/login"
                    className={`px-4 py-2 rounded-lg transition font-medium ${darkMode ? 'text-green-400 hover:text-green-300' : 'text-green-600 hover:text-green-700'}`}
                  >
                    Login
                  </Link>
                  <Link
        ...
        <div className="relative container mx-auto px-4 py-20">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <Link
                to="/produce"
                className="bg-white hover:bg-gray-100 text-green-600 px-8 py-4 rounded-lg text-lg font-semibold transition text-center shadow-lg"
              >
                Browse Produce
              </Link>
            </div>
      ...
      <section id="features" className={`py-20 ${darkMode ? 'bg-gray-900' : 'bg-white'}`}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className={`text-4xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Everything You Need to Succeed</h2>
            <p className={`text-xl ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Comprehensive tools for modern farming</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className={`p-8 rounded-xl hover:shadow-xl transition ${darkMode ? 'bg-gray-800' : 'bg-green-50'}`}>
              <div className="bg-green-600 w-16 h-16 rounded-full flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
              </div>
              <h3 className={`text-2xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Direct Market Access</h3>
            ...
            {/* Feature 2 */}
            <div className={`p-8 rounded-xl hover:shadow-xl transition ${darkMode ? 'bg-gray-800' : 'bg-blue-50'}`}>
              <div className="bg-blue-600 w-16 h-16 rounded-full flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548.547z" />
                </svg>
              </div>
              <h3 className={`text-2xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Expert Advice</h3>
              <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            ...
            {/* Feature 3 */}
            <div className={`p-8 rounded-xl hover:shadow-xl transition ${darkMode ? 'bg-gray-800' : 'bg-purple-50'}`}>
              ...
              <h3 className={`text-2xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Market Trends</h3>
              <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            ...
            {/* Feature 4 */}
            <div className={`p-8 rounded-xl hover:shadow-xl transition ${darkMode ? 'bg-gray-800' : 'bg-yellow-50'}`}>
              ...
              <h3 className={`text-2xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Community Forum</h3>
              <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            ...
            {/* Feature 5 */}
            <div className={`p-8 rounded-xl hover:shadow-xl transition ${darkMode ? 'bg-gray-800' : 'bg-red-50'}`}>
              <div className="bg-red-600 w-16 h-16 rounded-full flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
              </div>
              <h3 className={`text-2xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Buyer Requests</h3>
              <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            ...
            {/* Feature 6 */}
            <div className={`p-8 rounded-xl hover:shadow-xl transition ${darkMode ? 'bg-gray-800' : 'bg-indigo-50'}`}>
              <div className="bg-indigo-600 w-16 h-16 rounded-full flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className={`text-2xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Mobile Friendly</h3>
              <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
      ...
      <section id="how-it-works" className={`py-20 ${darkMode ? 'bg-gray-800' : 'bg-gray-50'}`}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className={`text-4xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>How It Works</h2>
            <p className={`text-xl ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Get started in three simple steps</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="text-center">
              ...
              <h3 className={`text-2xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Create Account</h3>
              <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            ...
            <div className="text-center">
              ...
              <h3 className={`text-2xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Complete Profile</h3>
              <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            ...
            <div className="text-center">
              ...
              <h3 className={`text-2xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Start Trading</h3>
              <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
      ...
      <section className={`py-20 ${darkMode ? 'bg-gray-900' : 'bg-white'}`}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className={`text-4xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Who Can Join?</h2>
            <p className={`text-xl ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Our platform serves everyone in the agricultural value chain</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Farmers */}
            <div className={`border-2 rounded-xl p-8 hover:shadow-xl transition ${darkMode ? 'border-green-700 bg-gray-800' : 'border-green-200 hover:border-green-600'}`}>
              <div className="text-center">
                ...
                <h3 className={`text-2xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Farmers</h3>
                <ul className={`text-left space-y-2 mb-6 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            ...
            {/* Buyers */}
            <div className={`border-2 rounded-xl p-8 hover:shadow-xl transition ${darkMode ? 'border-blue-700 bg-gray-800' : 'border-blue-200 hover:border-blue-600'}`}>
              <div className="text-center">
                ...
                <h3 className={`text-2xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Buyers</h3>
                <ul className={`text-left space-y-2 mb-6 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            ...
            {/* Experts */}
            <div className={`border-2 rounded-xl p-8 hover:shadow-xl transition ${darkMode ? 'border-purple-700 bg-gray-800' : 'border-purple-200 hover:border-purple-600'}`}>
              <div className="text-center">
                ...
                <h3 className={`text-2xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Experts</h3>
                <ul className={`text-left space-y-2 mb-6 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className={`text-4xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>About Sonnet Shamba</h2>
              <p className={`text-xl ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Transforming Kenyan Agriculture Through Technology</p>
            </div>

            <div className={`rounded-xl shadow-xl p-8 mb-8 ${darkMode ? 'bg-gray-900' : 'bg-white'}`}>
              <h3 className={`text-2xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Our Mission</h3>
              <p className={`leading-relaxed mb-6 ${darkMode ? 'text-gray-400' : 'text-gray-700'}`}>
              ...
              <h3 className={`text-2xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>What We Do</h3>
              <p className={`leading-relaxed mb-6 ${darkMode ? 'text-gray-400' : 'text-gray-700'}`}>
                Our platform bridges the gap between farmers, buyers and agricultural experts by offering:
              </p>
              <ul className={`space-y-3 mb-6 ${darkMode ? 'text-gray-400' : 'text-gray-700'}`}>
              ...
              <h3 className={`text-2xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Our Vision</h3>
              <p className={`leading-relaxed mb-6 ${darkMode ? 'text-gray-400' : 'text-gray-700'}`}>
              ...
              <h3 className={`text-2xl font-bold mb-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Why Sonnet Shamba?</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className={`font-semibold mb-1 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Fair Pricing</h4>
                    <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Direct connections eliminate middlemen, ensuring farmers get fair prices for their produce.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className={`font-semibold mb-1 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Trusted Platform</h4>
                    <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Verified users, secure transactions, and a supportive community you can trust.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className={`font-semibold mb-1 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Knowledge Sharing</h4>
                    <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Learn from experts and fellow farmers to improve your farming practices and productivity.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className={`font-semibold mb-1 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Easy to Use</h4>
                    <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Simple, intuitive platform designed for farmers with varying levels of tech experience.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className={`py-12 ${darkMode ? 'bg-gray-950' : 'bg-gray-900'}`}>
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {/* About */}
            <div>
              <h3 className="text-xl font-bold mb-4 text-white">Sonnet Shamba</h3>
          ...
          <div className={`border-t mt-8 pt-8 text-center text-gray-400 ${darkMode ? 'border-gray-800' : 'border-gray-800'}`}>
