            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-md p-6`}>
                    <div className="flex justify-between items-center mb-6">
                        <h2 className={`text-2xl font-bold ${darkMode ? 'text-white' : 'text-gray-800'}`}>My Produce Listings</h2>
                        <Link
                            to="/produce/create"
                    ...
                    {loading ? (
                        <div className="text-center py-12">
                            ...
                            <p className={`mt-4 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>Loading your listings...</p>
                        </div>
                    ) : error ? (
                        ...
                        <div className="text-center py-12">
                            ...
                            <p className={`mb-4 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>You haven't created any produce listings yet.</p>
                            <Link
                                to="/produce/create"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {listings.map((item) => (
                                <div
                                    key={item.listing_id}
                                    className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-md overflow-hidden hover:shadow-lg transition`}
                                >
                                    {/* Product Image */}
                                    <div className="h-40 bg-gray-200 dark:bg-gray-700 overflow-hidden">
                                        {item.image_url ? (
                                            ...
                                            <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-green-100 to-green-200 dark:from-green-900 dark:to-green-800">
                                                <svg className="w-16 h-16 text-green-400 dark:text-green-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div className="p-4">
                                        <div className="flex items-start justify-between mb-2">
                                            <h3 className={`text-lg font-bold ${darkMode ? 'text-white' : 'text-gray-800'}`}>{item.produce_name}</h3>
